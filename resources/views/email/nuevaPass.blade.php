      ...
      <tr>
        <td align="center" valign="top"  bgcolor="#ffffff">
          <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
            ...
            <!-- <tr>
              <td align="center"><a href="#" target="_blank" style="text-decoration:none;"><img src="{{asset('/img/logo.jpeg')}}" width="230" height="80" style="display:block;font-family: Arial, sans-serif; font-size:15px; line-height:18px; color:#30373b;  font-weight:bold;" border="0" alt="LoGo Here" /></a></td>
            </tr> -->
            <tr>
            ...
            <tr>
              <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; line-height:18px; color:#30373b; text-transform:uppercase; font-weight:bold;" class="em_font">
                       <p href="#" target="_blank" style="text-decoration:none; color:#30373b;">RECUPERACIÓN DE CONTRASEÑA</p>
            </td>
            </tr>
            <tr>
              <td height="14" style="font-size:1px; line-height:1px;">&nbsp;</td>
            ...
            <!-- === IMG WITH TEXT AND CTA === -->
              ...
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td valign="middle" align="center"><img src="https://1qy13e1kz4mu2twyf741jfes-wpengine.netdna-ssl.com/wp-content/uploads/2020/10/hipaa-password-requirements-400x400.png" width="150" height="149" alt="" style="display:block; font-family:Arial, sans-serif; font-size:25px; line-height:149px; color:#c27cbb;"  border="0" /></td>
                  </tr>
                  <br>
                  <tr>
                      
                    <td>Se ha generado la siguiente contraseña <strong> {{$pass}} </strong> para ingresar a su cuenta.</td>
                  </tr>
                  <a style="
display: inline-block;
background-color: rgb(32, 145, 69); 
padding: 12px; 
border-radius: 4px; 
color: white; 
text-decoration: none;
cursor: pointer; "
href="https://sistema-camaroneras.web.app/">Ir al sitio</a>

<br><br>
<p>Si el botón anterior no funciona copie y pegue el siguiente enlace en su navegador </p>
<p>https://sistema-camaroneras.web.app/</p>
                  <tr>
                    <td height="25" class="em_height">&nbsp;</td>
                  </tr>
                  <!-- <tr>
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:20px; color:#feae39;">Este correo se envió automáticamente</td>
                  </tr>
                  <tr>
                    <td height="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
                  </tr>
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:16px; line-height:20px; color:#feae39;">Por favor no lo responda.</td>
                  </tr>
                  <tr>
                  ...
                  <!-- <tr>
                    <td valign="top" align="center">
                      <table width="210" border="0" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                          <td valign="middle" align="center" height="45" bgcolor="#feae39" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff; text-transform:uppercase;"><a href="#" target="_blank" style="text-decoration:none; color:#ffffff; display:block; line-height:45px;">Ver documento</a></td>
                        </tr>
                      </table>
                    </td>
                  </tr> -->
                  ...
                  <tr>
                    <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; line-height:22px; color:#999999;">Sistema Camaronera Horconcito
      ...
      <tr>
        <td align="center" valign="top"  bgcolor="#30373b" class="em_aside">
          <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
            ...
            <tr>
              <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:18px; color:#848789;text-transform:uppercase;">
                &copy;2&zwnj;021 CAMARONERA HORCONCITO Todos los derechos reservados.
              </td>
            </tr>
            <tr>
              <td height="10" style="font-size:1px; line-height:1px;">&nbsp;</td>
